...
namespace _5gpro.Funcoes
{
    class DatabaseUpdate
    {
        ...
        public bool Migrate()
        {
            ...
            if (versao_base == "0046_vendedoranf") versao_base = Migrate_0047(versao_base);
            if (versao_base == "0047_alteracaoemloteitens") versao_base = Migrate_0048(versao_base);
        ...
        private string Migrate_0047(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Configuracao.Conecta))
            {
                ...
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0047_alteracaoemloteitens");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0047_alteracaoemloteitens";
            }
            return versao_base;
        }
        private string Migrate_0048(string v)
        {
            string versao_base = v;
            using (MySQLConn sql = new MySQLConn(Configuracao.Conecta))
            {
                sql.beginTransaction();
                sql.Query = @"CREATE TABLE IF NOT EXISTS banco (
                              idbanco INT NOT NULL AUTO_INCREMENT,
                              codigo CHAR(3) NOT NULL,
                              ispb CHAR(8) NOT NULL,
                              nome VARCHAR(100) NOT NULL,
                              nomereduzido VARCHAR(100) NOT NULL,
                              compe TINYINT NOT NULL,
                              acessoprincipal VARCHAR(100) NOT NULL,
                              iniciooperacao DATETIME NOT NULL,
                              PRIMARY KEY (idbanco))
                            ENGINE = InnoDB";
                sql.insertQuery();

                sql.Query = @"INSERT INTO banco (ispb, nomereduzido, codigo, compe, acessoprincipal, nome, iniciooperacao) VALUES
                            ('00000000','BCO DO BRASIL S.A.','001', TRUE,'RSFN','Banco do Brasil S.A.','2002/04/22'),
                            ('00000208','BRB - BCO DE BRASILIA S.A.','070', TRUE,'RSFN','Banco de Brasília S.A.','2002/04/22'),
                            ('00250699','AGK CC S.A.','272', FALSE,'RSFN','AGK Corretora de Câmbio S.A.','2018/11/21'),
                            ('00315557','CONF NAC COOP CENTRAIS UNICRED','136', TRUE,'RSFN','Confederação Nacional das Cooperativas Centrais Unicred Ltda – Unicred do Brasil','2014/07/28'),
                            ('00360305','CAIXA ECONOMICA FEDERAL','104', TRUE,'RSFN','Caixa Econômica Federal','2002/04/22'),
                            ('00416968','BANCO INTER','077', TRUE,'RSFN','Banco Inter S.A.','2008/08/15'),
                            ('00517645','BCO RIBEIRAO PRETO S.A.','741', TRUE,'RSFN','Banco Ribeirão Preto S.A.','2002/04/22'),
                            ('00556603','BCO BARIGUI INV FIN S/A','330', FALSE,'RSFN','Banco Barigui de Investimentos e Financiamentos S.A','2019/07/22'),
                            ('00558456','BCO CETELEM S.A.','739', TRUE,'RSFN','Banco Cetelem S.A.','2002/04/22'),
                            ('00795423','BANCO SEMEAR','743', TRUE,'RSFN','Banco Semear S.A.','2002/04/22'),
                            ('00806535','PLANNER CV S.A.','100', FALSE,'RSFN','Planner Corretora de Valores S.A.','2011/04/27'),
                            ('00997185','BCO B3 S.A.','096', FALSE,'RSFN','Banco B3 S.A.','2004/11/12'),
                            ('01023570','BCO RABOBANK INTL BRASIL S.A.','747', TRUE,'RSFN','Banco Rabobank International Brasil S.A.','2002/04/22'),
                            ('01073966','CCR DE ABELARDO LUZ','322', FALSE,'RSFN','Cooperativa de Crédito Rural de Abelardo Luz - Sulcredi/Crediluz','2019/06/14'),
                            ('01181521','BCO COOPERATIVO SICREDI S.A.','748', TRUE,'RSFN','Banco Cooperativo Sicredi S. A.','2002/04/22'),
                            ('01522368','BCO BNP PARIBAS BRASIL S A','752', TRUE,'RSFN','Banco BNP Paribas Brasil S.A.','2002/04/22'),
                            ('01634601','CCCM UNICRED CENTRAL RS','091', FALSE,'RSFN','Central de Cooperativas de Economia e Crédito Mútuo do Est RS - Unicred','2010/11/22'),
                            ('01701201','KIRTON BANK','399', FALSE,'RSFN','Kirton Bank S.A. - Banco Múltiplo','2002/04/22'),
                            ('01800019','PORTOCRED S.A. - CFI','108', FALSE,'RSFN','PortoCred S.A. Crédito, Financiamento e Investimento','2011/11/03'),
                            ('02038232','BANCOOB','756', TRUE,'RSFN','Banco Cooperativo do Brasil S/A - Bancoob','2002/04/22'),
                            ('02318507','BCO KEB HANA DO BRASIL S.A.','757', TRUE,'RSFN','Banco Keb Hana do Brasil S. A.','2002/04/22'),
                            ('02332886','XP INVESTIMENTOS CCTVM S/A','102', FALSE,'RSFN','XP Investimentos Corretora de Câmbio Títulos e Valores Mobiliários S.A.','2011/11/22'),
                            ('02398976','UNIPRIME NORTE DO PARANÁ - CC','084', TRUE,'RSFN','Uniprime Norte do Paraná - Cooperativa de Crédito Ltda.','2009/11/24'),
                            ('02685483','CM CAPITAL MARKETS CCTVM LTDA','180', FALSE,'RSFN','CM Capital Markets Corretora de Câmbio, Títulos e Valores Mobiliários Ltda.','2017/01/20'),
                            ('02801938','BCO MORGAN STANLEY S.A.','066', FALSE,'RSFN','Banco Morgan Stanley S. A.','2002/04/22'),
                            ('02819125','UBS BRASIL CCTVM S.A.','015', FALSE,'RSFN','UBS Brasil Corretora de Câmbio, Títulos e Valores Mobiliários S.A.','2011/03/15'),
                            ('02992317','TREVISO CC S.A.','143', FALSE,'Internet','Treviso Corretora de Câmbio S.A.','2015/08/24'),
                            ('03012230','HIPERCARD BM S.A.','062', TRUE,'RSFN','Hipercard Banco Múltiplo S.A.','2002/04/22'),
                            ('03017677','BCO. J.SAFRA S.A.','074', TRUE,'RSFN','Banco J. Safra S.A.','2004/08/26'),
                            ('03046391','UNIPRIME CENTRAL CCC LTDA.','099', TRUE,'RSFN','Uniprime Central – Central Interestadual de Cooperativas de Crédito Ltda.','2011/01/11'),
                            ('03323840','BCO ALFA S.A.','025', TRUE,'RSFN','Banco Alfa S.A.','2002/04/22'),
                            ('03502968','PI DTVM S.A.','315', FALSE,'RSFN','PI Distribuidora de Títulos e Valores Mobiliários S.A.','2019/01/24'),
                            ('03532415','BCO ABN AMRO S.A.','075', FALSE,'RSFN','Banco ABN Amro S.A.','2005/11/11'),
                            ('03609817','BCO CARGILL S.A.','040', FALSE,'RSFN','Banco Cargill S.A.','2002/04/22'),
                            ('03751794','TERRA INVESTIMENTOS DTVM','307', FALSE,'RSFN','Terra Investimentos Distribuidora de Títulos e Valores Mobiliários Ltda.','2018/10/25'),
                            ('03973814','SERVICOOP','190', FALSE,'RSFN','Servicoop - Cooperativa de Economia e Crédito Mútuo dos Servidores Públicos Esta','2017/10/16'),
                            ('04062902','VISION S.A. CC','296', FALSE,'Internet','Vision S.A. Corretora de Câmbio','2019/02/11'),
                            ('04184779','BANCO BRADESCARD','063', TRUE,'RSFN','Banco Bradescard S.A.','2002/04/22'),
                            ('04257795','NOVA FUTURA CTVM LTDA.','191', FALSE,'RSFN','Nova Futura Corretora de Títulos e Valores Mobiliários Ltda.','2017/06/22'),
                            ('04332281','GOLDMAN SACHS DO BRASIL BM S.A','064', FALSE,'RSFN','Goldman Sachs do Brasil  Banco Múltiplo S. A.','2002/04/22'),
                            ('04632856','CCC NOROESTE BRASILEIRO LTDA.','097', TRUE,'RSFN','Cooperativa Central de Crédito Noroeste Brasileiro Ltda - CentralCredi','2011/02/08'),
                            ('04715685','CCM DESP TRÂNS SC E RS','016', FALSE,'RSFN','Coop de Créd. Mútuo dos Despachantes de Trânsito de SC e Rio Grande do Sul','2012/05/08'),
                            ('04814563','SOROCRED CFI S.A.','299', FALSE,'RSFN','Sorocred - Crédito, Financiamento e Investimento S/A','2018/12/03'),
                            ('04866275','BANCO INBURSA','012', FALSE,'RSFN','Banco Inbursa S.A.','2017/05/04'),
                            ('04902979','BCO DA AMAZONIA S.A.','003', TRUE,'RSFN','Banco da Amazônia S.A.','2002/04/22'),
                            ('04913129','CONFIDENCE CC S.A.','060', FALSE,'Internet','Confidence Corretora de Câmbio S.A.','2010/09/21'),
                            ('04913711','BCO DO EST. DO PA S.A.','037', TRUE,'RSFN','Banco do Estado do Pará S.A.','2002/04/22'),
                            ('05442029','CASA CREDITO S.A. SCM','159', FALSE,'RSFN','Casa do Crédito S.A. Sociedade de Crédito ao Microempreendedor','2017/09/04'),
                            ('05452073','ALBATROSS CCV S.A','172', FALSE,'Internet','Albatross Corretora de Câmbio e Valores S.A','2017/09/14'),
                            ('05463212','COOP CENTRAL AILOS','085', TRUE,'RSFN','Cooperativa Central de Crédito - Ailos','2010/05/17'),
                            ('05790149','CENTRAL COOPERATIVA DE CRÉDITO NO ESTADO DO ESPÍRITO SANTO','114', TRUE,'RSFN','Central Cooperativa de Crédito no Estado do Espírito Santo - CECOOP','2011/10/27'),
                            ('06271464','BCO BBI S.A.','036', TRUE,'RSFN','Banco Bradesco BBI S.A.','2002/04/22'),
                            ('07207996','BCO BRADESCO FINANC. S.A.','394', TRUE,'RSFN','Banco Bradesco Financiamentos S.A.','2002/04/22'),
                            ('07237373','BCO DO NORDESTE DO BRASIL S.A.','004', TRUE,'RSFN','Banco do Nordeste do Brasil S.A.','2002/04/22'),
                            ('07450604','BCO CCB BRASIL S.A.','320', TRUE,'RSFN','China Construction Bank (Brasil) Banco Múltiplo S/A','2002/04/22'),
                            ('07512441','HS FINANCEIRA','189', FALSE,'RSFN','HS Financeira S/A Crédito, Financiamento e Investimentos','2017/06/05'),
                            ('07652226','LECCA CFI S.A.','105', FALSE,'RSFN','Lecca Crédito, Financiamento e Investimento S/A','2011/12/27'),
                            ('07656500','BCO KDB BRASIL S.A.','076', FALSE,'RSFN','Banco KDB do Brasil S.A.','2006/04/10'),
                            ('07679404','BANCO TOPÁZIO S.A.','082', FALSE,'RSFN','Banco Topazio S.A.','2009/06/12'),
                            ('07853842','CCR DE OURO','286', FALSE,'Internet','Cooperativa de Crédito Rural de Ouro Sulcredi/Ouro','2018/09/17'),
                            ('07945233','PÓLOCRED SCMEPP LTDA.','093', FALSE,'RSFN','Pólocred Sociedade de Crédito ao Microempreendedor e à Empresa de Pequeno Porte','2010/11/09'),
                            ('08253539','CCR DE SÃO MIGUEL DO OESTE','273', FALSE,'Internet','Cooperativa de Crédito Rural de São Miguel do Oeste - Sulcredi/São Miguel','2018/04/24'),
                            ('08561701','PAGSEGURO','290', FALSE,'RSFN','Pagseguro Internet S.A.','2018/11/07'),
                            ('09105360','ICAP DO BRASIL CTVM LTDA.','157', FALSE,'RSFN','ICAP do Brasil Corretora de Títulos e Valores Mobiliários Ltda.','2016/02/12'),
                            ('09210106','SOCRED SA - SCMEPP','183', FALSE,'Internet','Socred S.A. - Sociedade de Crédito ao Microempreendedor e à Empresa de Pequeno P','2017/06/12'),
                            ('09274232','STATE STREET BR S.A. BCO COMERCIAL','014', FALSE,'RSFN','State Street Brasil S.A. - Banco Comercial','2008/08/08'),
                            ('09313766','CARUANA SCFI','130', FALSE,'RSFN','Caruana S.A.Sociedade de Crédito, Financiamento e Investimento','2013/08/12'),
                            ('09512542', 'CODEPE CVC S.A.', '127', FALSE, 'Internet', 'Codepe Corretora de Valores e Câmbio S.A.', '2012/11/09'),
                            ('09516419', 'BCO ORIGINAL DO AGRO S/A', '079', FALSE, 'RSFN', 'Banco Original do Agronegócio S.A.', '2008/07/25'),
                            ('10264663', 'BANCOSEGURO S.A.', '081', FALSE, 'RSFN', 'BancoSeguro S.A.', '2008/10/24'),
                            ('10398952', 'CRESOL CONFEDERAÇÃO', '133', TRUE, 'RSFN', 'Confederação Nacional das Cooperativas Centrais de Crédito e Economia Familiar e', '2016/05/02'),
                            ('10573521', 'MERCADO PAGO', '323', FALSE, 'RSFN', 'MercadoPago.com Representações Ltda.', '2019/06/24'),
                            ('10664513', 'BCO AGIBANK S.A.', '121', TRUE, 'RSFN', 'Banco Agibank S.A.', '2012/04/04'),
                            ('10690848', 'BCO DA CHINA BRASIL S.A.', '083', TRUE, 'RSFN', 'Banco da China Brasil S.A.', '2009/07/14'),
                            ('10853017', 'GET MONEY CC LTDA', '138', FALSE, 'Internet', 'Get Money Corretora de Câmbio S.A.', '2014/07/14'),
                            ('10866788', 'BCO BANDEPE S.A.', '024', FALSE, 'RSFN', 'Banco Bandepe S.A.', '2002/04/22'),
                            ('11495073', 'OM DTVM LTDA', '319', FALSE, 'Internet', 'OM Distribuidora de Títulos e Valores Mobiliários Ltda.', '2019/03/01'),
                            ('11703662', 'TRAVELEX BANCO DE CÂMBIO S.A.', '095', FALSE, 'RSFN', 'Travelex Banco de Câmbio S.A.', '2010/06/22'),
                            ('11758741', 'BANCO FINAXIS', '094', TRUE, 'RSFN', 'Banco Finaxis S.A.', '2010/08/23'),
                            ('11932017', 'STANDARD CHARTERED BI S.A.', '118', FALSE, 'RSFN', 'Standard Chartered Bank (Brasil) S.A. Banco de Investimento', '2011/09/26'),
                            ('11970623', 'SENFF S.A. - CFI', '276', FALSE, 'RSFN', 'Senff S.A. - Crédito, Financiamento e Investimento', '2018/06/12'),
                            ('12865507', 'BRK S.A. CFI', '092', FALSE, 'RSFN', 'BRK S.A. Crédito, Financiamento e Investimento', '2010/07/01'),
                            ('13009717', 'BCO DO EST. DE SE S.A.', '047', TRUE, 'RSFN', 'Banco do Estado de Sergipe S.A.', '2002/04/22'),
                            ('13059145', 'BEXS BCO DE CAMBIO S.A.', '144', FALSE, 'RSFN', 'Bexs Banco de Câmbio S.A.', '2016/05/23'),
                            ('13220493', 'BR PARTNERS BI', '126', FALSE, 'RSFN', 'BR Partners Banco de Investimento S.A.', '2013/01/04'),
                            ('13293225', 'ÓRAMA DTVM S.A.', '325', FALSE, 'RSFN', 'Órama Distribuidora de Títulos e Valores Mobiliários S.A.', '2019/05/31'),
                            ('13370835', 'BPP IP S.A.', '301', FALSE, 'RSFN', 'BPP Instituição de Pagamento S.A.', '2018/09/26'),
                            ('13486793', 'BRL TRUST DTVM SA', '173', FALSE, 'RSFN', 'BRL Trust Distribuidora de Títulos e Valores Mobiliários S.A.', '2016/11/28'),
                            ('13720915', 'BCO WESTERN UNION', '119', FALSE, 'RSFN', 'Banco Western Union do Brasil S.A.', '2011/10/10'),
                            ('14190547', 'CAMBIONET CC LTDA', '309', FALSE, 'Internet', 'Cambionet Corretora de Câmbio Ltda.', '2018/11/21'),
                            ('14388334', 'PARANA BCO S.A.', '254', TRUE, 'RSFN', 'Parana Banco S. A.', '2002/04/22'),
                            ('14511781', 'BARIGUI CH', '268', FALSE, 'RSFN', 'Barigui Companhia Hipotecária', '2017/12/21'),
                            ('15173776', 'BCO CAPITAL S.A.', '412', TRUE, 'RSFN', 'Banco Capital S. A.', '2002/04/22'),
                            ('15357060', 'BCO WOORI BANK DO BRASIL S.A.', '124', TRUE, 'RSFN', 'Banco Woori Bank do Brasil S.A.', '2012/08/09'),
                            ('15581638', 'FACTA S.A. CFI', '149', FALSE, 'RSFN', 'Facta Financeira S.A. - Crédito Financiamento e Investimento', '2015/07/08'),
                            ('16501555', 'STONE PAGAMENTOS S.A.', '197', FALSE, 'RSFN', 'Stone Pagamentos S.A.', '2017/10/18'),
                            ('16944141', 'BROKER BRASIL CC LTDA.', '142', FALSE, 'RSFN', 'Broker Brasil Corretora de Câmbio Ltda.', '2015/06/23'),
                            ('17184037', 'BCO MERCANTIL DO BRASIL S.A.', '389', TRUE, 'RSFN', 'Banco Mercantil do Brasil S.A.', '2002/04/22'),
                            ('17298092', 'BCO ITAÚ BBA S.A.', '184', FALSE, 'RSFN', 'Banco Itaú BBA S.A.', '2002/04/22'),
                            ('17351180', 'BCO TRIANGULO S.A.', '634', TRUE, 'RSFN', 'Banco Triângulo S.A.', '2002/04/22'),
                            ('17352220', 'SENSO CCVM S.A.', '545', FALSE, 'Internet', 'Senso Corretora de Câmbio e Valores Mobiliários S.A.', '2010/09/27'),
                            ('17453575', 'ICBC DO BRASIL BM S.A.', '132', FALSE, 'RSFN', 'ICBC do Brasil Banco Múltiplo S.A.', '2013/09/26'),
                            ('17772370', 'VIPS CC LTDA.', '298', FALSE, 'Internet', 'Vip\'s Corretora de Câmbio Ltda.', '2018/08/15'),
                            ('18188384', 'CREFAZ SCMEPP LTDA', '321', FALSE, 'RSFN', 'Crefaz Sociedade de Crédito ao Microempreendedor e a Empresa de Pequeno Porte Lt', '2019/06/11'),
                            ('18236120', 'NU PAGAMENTOS S.A.', '260', FALSE, 'RSFN', 'Nu Pagamentos S.A.', '2017/10/10'),
                            ('18520834', 'UBS BRASIL BI S.A.', '129', FALSE, 'RSFN', 'UBS Brasil Banco de Investimento S.A.', '2014/03/12'),
                            ('19307785', 'MS BANK S.A. BCO DE CÂMBIO', '128', FALSE, 'RSFN', 'MS Bank S.A. Banco de Câmbio', '2015/04/27'),
                            ('20155248', 'PARMETAL DTVM LTDA', '194', FALSE, 'RSFN', 'Parmetal Distribuidora de Títulos e Valores Mobiliários Ltda.', '2017/10/25'),
                            ('22610500', 'VORTX DTVM LTDA.', '310', FALSE, 'RSFN', 'Vortx Distribuidora de Títulos e Valores Mobiliários Ltda.', '2018/10/18'),
                            ('23522214', 'COMMERZBANK BRASIL S.A. - BCO MÚLTIPLO', '163', FALSE, 'RSFN', 'Commerzbank Brasil S.A. - Banco Múltiplo', '2016/08/10'),
                            ('23862762', 'AVISTA S.A. CFI', '280', FALSE, 'RSFN', 'Avista S.A. Crédito, Financiamento e Investimento', '2018/05/10'),
                            ('24074692', 'GUITTA CC LTDA', '146', FALSE, 'Internet', 'Guitta Corretora de Câmbio Ltda.', '2015/05/20'),
                            ('26563270', 'CCR DE PRIMAVERA DO LESTE', '279', TRUE, 'RSFN', 'Cooperativa de Crédito Rural de Primavera do Leste', '2018/06/05'),
                            ('27406222', 'DACASA FINANCEIRA S/A - SCFI', '182', FALSE, 'RSFN', 'Dacasa Financeira S/A - Sociedade de Crédito, Financiamento e Investimento', '2017/08/09'),
                            ('27652684', 'GENIAL INVESTIMENTOS CVM S.A.', '278', FALSE, 'RSFN', 'Genial Investimentos Corretora de Valores Mobiliários S.A.', '2018/05/14'),
                            ('27842177', 'IB CCTVM S.A.', '271', FALSE, 'RSFN', 'IB Corretora de Câmbio, Títulos e Valores Mobiliários S.A.', '2018/02/26'),
                            ('28127603', 'BCO BANESTES S.A.', '021', TRUE, 'RSFN', 'Banestes S.A. Banco do Estado do Espírito Santo', '2002/04/22'),
                            ('28195667', 'BCO ABC BRASIL S.A.', '246', TRUE, 'RSFN', 'Banco ABC Brasil S.A.', '2002/04/22'),
                            ('28650236', 'BS2 DTVM S.A.', '292', FALSE, 'RSFN', 'BS2 Distribuidora de Títulos e Valores Mobiliários S.A.', '2018/10/24'),
                            ('29030467', 'SCOTIABANK BRASIL', '751', FALSE, 'RSFN', 'Scotiabank Brasil S.A. Banco Múltiplo', '2002/04/22'),
                            ('30306294', 'BANCO BTG PACTUAL S.A.', '208', TRUE, 'RSFN', 'Banco BTG Pactual S.A.', '2002/04/22'),
                            ('30723886', 'BCO MODAL S.A.', '746', TRUE, 'RSFN', 'Banco Modal S.A.', '2002/04/22'),
                            ('31597552', 'BCO CLASSICO S.A.', '241', TRUE, 'RSFN', 'Banco Clássico S.A.', '2002/04/22'),
                            ('31872495', 'BCO C6 S.A.', '336', FALSE, 'RSFN', 'Banco C6 S.A.', '2019/01/31'),
                            ('31880826', 'BCO GUANABARA S.A.', '612', TRUE, 'RSFN', 'Banco Guanabara S.A.', '2002/04/22'),
                            ('31895683', 'BCO INDUSTRIAL DO BRASIL S.A.', '604', TRUE, 'RSFN', 'Banco Industrial do Brasil S.A.', '2002/04/22'),
                            ('32062580', 'BCO CREDIT SUISSE S.A.', '505', TRUE, 'RSFN', 'Banco Credit Suisse (Brasil) S.A.', '2002/04/22'),
                            ('32402502', 'QI SCD S.A.', '329', FALSE, 'RSFN', 'QI Sociedade de Crédito Direto S.A.', '2019/04/30'),
                            ('32648370', 'FAIR CC S.A.', '196', FALSE, 'Internet', 'Fair Corretora de Câmbio S.A.', '2019/09/11'),
                            ('32997490', 'CREDITAS SCD', '342', FALSE, 'RSFN', 'Creditas Sociedade de Crédito Direto S.A.', '2019/07/26'),
                            ('33042151', 'BCO LA NACION ARGENTINA', '300', TRUE, 'RSFN', 'Banco de la Nacion Argentina', '2002/04/22'),
                            ('33042953', 'CITIBANK N.A.', '477', TRUE, 'RSFN', 'Citibank N.A.', '2002/04/22'),
                            ('33132044', 'BCO CEDULA S.A.', '266', TRUE, 'RSFN', 'Banco Cédula S.A.', '2002/04/22'),
                            ('33147315', 'BCO BRADESCO BERJ S.A.', '122', TRUE, 'RSFN', 'Banco Bradesco BERJ S.A.', '2011/11/08'),
                            ('33172537', 'BCO J.P. MORGAN S.A.', '376', TRUE, 'RSFN', 'Banco J. P. Morgan S. A.', '2002/04/22'),
                            ('33466988', 'BCO CAIXA GERAL BRASIL S.A.', '473', TRUE, 'RSFN', 'Banco Caixa Geral - Brasil S.A.', '2009/03/31'),
                            ('33479023', 'BCO CITIBANK S.A.', '745', TRUE, 'RSFN', 'Banco Citibank S.A.', '2002/04/22'),
                            ('33603457', 'BCO RODOBENS S.A.', '120', TRUE, 'RSFN', 'Banco Rodobens SA', '2012/02/06'),
                            ('33644196', 'BCO FATOR S.A.', '265', TRUE, 'RSFN', 'Banco Fator S.A.', '2002/04/22'),
                            ('33657248', 'BNDES', '007', FALSE, 'RSFN', 'Banco Nacional de Desenvolvimento Econômico e Social BNDES', '2014/06/30'),
                            ('33775974', 'ATIVA S.A. INVESTIMENTOS CCTVM', '188', FALSE, 'RSFN', 'Ativa Investimentos S.A. Corretora de Títulos Câmbio e Valores', '2017/07/28'),
                            ('33862244', 'BGC LIQUIDEZ DTVM LTDA', '134', FALSE, 'RSFN', 'BGC Liquidez Distribuidora de Títulos e Valores Mobiliários Ltda.', '2014/07/28'),
                            ('33870163', 'BCO ALVORADA S.A.', '641', FALSE, 'RSFN', 'Banco Alvorada S.A.', '2002/04/22'),
                            ('33885724', 'BANCO ITAÚ CONSIGNADO S.A.', '029', FALSE, 'RSFN', 'Banco Itaú Consignado S.A.', '2002/04/22'),
                            ('33923798', 'BCO MÁXIMA S.A.', '243', TRUE, 'RSFN', 'Banco Máxima S.A.', '2002/04/22'),
                            ('34111187', 'HAITONG BI DO BRASIL S.A.', '078', FALSE, 'RSFN', 'Haitong Banco de Investimento do Brasil S.A.', '2008/07/31'),
                            ('36113876', 'OLIVEIRA TRUST DTVM S.A.', '111', FALSE, 'RSFN', 'Oliveira Trust Distribuidora de Títulos e Valores Mobiliários S.A.', '2011/03/24'),
                            ('40303299', 'PORTOPAR DTVM LTDA', '306', FALSE, 'RSFN', 'Portopar Distribuidora de Títulos e Valores Mobiliários Ltda.', '2019/02/06'),
                            ('42272526', 'BNY MELLON BCO S.A.', '017', TRUE, 'RSFN', 'BNY Mellon Banco S.A.', '2012/11/19'),
                            ('43180355', 'PERNAMBUCANAS FINANC S.A. CFI', '174', FALSE, 'RSFN', 'Pernambucanas Financiadora S.A. Crédito, Financiamento e Investimento', '2017/11/21'),
                            ('44189447', 'BCO LA PROVINCIA B AIRES BCE', '495', FALSE, 'RSFN', 'Banco de La Provincia de Buenos Aires', '2002/04/22'),
                            ('45246410', 'BRASIL PLURAL S.A. BCO.', '125', TRUE, 'RSFN', 'Brasil Plural S.A. Banco Múltiplo', '2012/11/19'),
                            ('46518205', 'JPMORGAN CHASE BANK', '488', FALSE, 'RSFN', 'JPMorgan Chase Bank, National Association', '2002/04/22'),
                            ('48795256', 'BCO ANDBANK S.A.', '065', TRUE, 'RSFN', 'Banco AndBank (Brasil) S.A.', '2002/04/22'),
                            ('49336860', 'ING BANK N.V.', '492', FALSE, 'RSFN', 'ING Bank N.V.', '2002/04/22'),
                            ('50579044', 'LEVYCAM CCV LTDA', '145', FALSE, 'Internet', 'Levycam - Corretora de Câmbio e Valores Ltda.', '2015/06/16'),
                            ('50585090', 'BCV', '250', FALSE, 'RSFN', 'BCV - Banco de Crédito e Varejo S/A', '2002/04/22'),
                            ('51938876', 'BCO REP ORIENTAL URUGUAY BCE', '494', FALSE, 'RSFN', 'Banco de La Republica Oriental del Uruguay', '2002/04/22'),
                            ('52937216', 'BEXS CC S.A.', '253', FALSE, 'Internet', 'Bexs Corretora de Câmbio S/A', '2016/11/11'),
                            ('53518684', 'HSBC BANCO DE INVESTIMENTO', '269', FALSE, 'RSFN', 'HSBC Brasil S.A. Banco de Investimento', '2018/02/07'),
                            ('54403563', 'BCO ARBI S.A.', '213', TRUE, 'RSFN', 'Banco Arbi S.A.', '2002/04/22'),
                            ('55230916', 'INTESA SANPAOLO BRASIL S.A. BM', '139', FALSE, 'RSFN', 'Intesa Sanpaolo Brasil S.A. - Banco Múltiplo', '2015/05/08'),
                            ('57839805', 'BCO TRICURY S.A.', '018', TRUE, 'RSFN', 'Banco Tricury S.A.', '2013/08/05'),
                            ('58160789', 'BCO SAFRA S.A.', '422', TRUE, 'RSFN', 'Banco Safra S.A.', '2002/04/22'),
                            ('58497702', 'SMARTBANK', '630', FALSE, 'RSFN', 'Banco Smartbank S.A.', '2002/04/22'),
                            ('58616418', 'BCO FIBRA S.A.', '224', TRUE, 'RSFN', 'Banco Fibra S.A.', '2002/04/22'),
                            ('59118133', 'BCO LUSO BRASILEIRO S.A.', '600', TRUE, 'RSFN', 'Banco Luso Brasileiro S.A.', '2002/04/22'),
                            ('59285411', 'BANCO PAN', '623', TRUE, 'RSFN', 'Banco Pan S.A.', '2002/04/22'),
                            ('59438325', 'BCO BRADESCO CARTOES S.A.', '204', TRUE, 'RSFN', 'Banco Bradesco Cartões S.A.', '2002/04/22'),
                            ('59588111', 'BCO VOTORANTIM S.A.', '655', TRUE, 'RSFN', 'Banco Votorantim S.A.', '2002/04/22'),
                            ('60394079', 'BCO ITAUBANK S.A.', '479', FALSE, 'RSFN', 'Banco ItauBank S.A.', '2002/04/22'),
                            ('60498557', 'BCO MUFG BRASIL S.A.', '456', TRUE, 'RSFN', 'Banco MUFG Brasil S.A.', '2002/04/22'),
                            ('60518222', 'BCO SUMITOMO MITSUI BRASIL S.A.', '464', TRUE, 'RSFN', 'Banco Sumitomo Mitsui Brasileiro S.A.', '2002/04/22'),
                            ('60701190', 'ITAÚ UNIBANCO S.A.', '341', TRUE, 'RSFN', 'Itaú Unibanco  S.A.', '2002/04/22'),
                            ('60746948', 'BCO BRADESCO S.A.', '237', TRUE, 'RSFN', 'Banco Bradesco S.A.', '2002/04/22'),
                            ('60850229', 'OMNI BANCO S.A.', '613', TRUE, 'RSFN', 'Omni Banco S.A.', '2002/04/22'),
                            ('60872504', 'ITAÚ UNIBANCO HOLDING S.A.', '652', TRUE, 'RSFN', 'Itaú Unibanco Holding S.A.', '2002/04/22'),
                            ('60889128', 'BCO SOFISA S.A.', '637', TRUE, 'RSFN', 'Banco Sofisa S. A.', '2002/04/22'),
                            ('61024352', 'BCO INDUSVAL S.A.', '653', TRUE, 'RSFN', 'Banco Indusval S. A.', '2002/04/22'),
                            ('61033106', 'BCO CREFISA S.A.', '069', TRUE, 'RSFN', 'Banco Crefisa S.A.', '2005/11/18'),
                            ('61088183', 'BCO MIZUHO S.A.', '370', FALSE, 'RSFN', 'Banco Mizuho do Brasil S.A.', '2002/04/22'),
                            ('61182408', 'BANCO INVESTCRED UNIBANCO S.A.', '249', TRUE, 'RSFN', 'Banco Investcred Unibanco S.A.', '2002/04/22'),
                            ('61186680', 'BCO BMG S.A.', '318', TRUE, 'RSFN', 'Banco BMG S.A.', '2002/04/22'),
                            ('61348538', 'BCO FICSA S.A.', '626', TRUE, 'RSFN', 'Banco Ficsa S. A.', '2002/04/22'),
                            ('61444949', 'SAGITUR CC LTDA', '270', FALSE, 'Internet', 'Sagitur Corretora de Câmbio Ltda.', '2018/08/01'),
                            ('61533584', 'BCO SOCIETE GENERALE BRASIL', '366', TRUE, 'RSFN', 'Banco Société Générale Brasil S.A.', '2002/04/22'),
                            ('61723847', 'MAGLIANO S.A. CCVM', '113', FALSE, 'RSFN', 'Magliano S.A. Corretora de Cambio e Valores Mobiliarios', '2011/11/28'),
                            ('61747085', 'TULLETT PREBON BRASIL CVC LTDA', '131', FALSE, 'RSFN', 'Tullett Prebon Brasil Corretora de Valores e Câmbio Ltda.', '2013/07/15'),
                            ('61809182', 'C.SUISSE HEDGING-GRIFFO CV S/A', '011', FALSE, 'RSFN', 'Credit Suisse Hedging-Griffo Corretora de Valores S.A.', '2011/06/28'),
                            ('61820817', 'BCO PAULISTA S.A.', '611', TRUE, 'RSFN', 'Banco Paulista S.A.', '2002/04/22'),
                            ('62073200', 'BOFA MERRILL LYNCH BM S.A.', '755', TRUE, 'RSFN', 'Bank of America Merrill Lynch Banco Múltiplo S.A.', '2007/11/09'),
                            ('62109566', 'CCR REG MOGIANA', '089', TRUE, 'RSFN', 'Cooperativa de Crédito Rural da Região da Mogiana', '2010/08/30'),
                            ('62144175', 'BCO PINE S.A.', '643', TRUE, 'RSFN', 'Banco Pine S.A.', '2002/04/22'),
                            ('62169875', 'EASYNVEST - TÍTULO CV SA', '140', FALSE, 'RSFN', 'Easynvest - Título Corretora de Valores SA', '2015/05/26'),
                            ('62232889', 'BCO DAYCOVAL S.A', '707', TRUE, 'RSFN', 'Banco Daycoval S.A.', '2002/04/22'),
                            ('62237649', 'CAROL DTVM LTDA.', '288', FALSE, 'Internet', 'Carol Distribuidora de Títulos e Valores Mobiliários Ltda.', '2018/07/05'),
                            ('62287735', 'RENASCENCA DTVM LTDA', '101', FALSE, 'RSFN', 'Renascença Distribuidora de Títulos e Valores Mobiliários Ltda.', '2010/04/22'),
                            ('62331228', 'DEUTSCHE BANK S.A.BCO ALEMAO', '487', TRUE, 'RSFN', 'Deutsche Bank S.A. - Banco Alemão', '2002/04/22'),
                            ('62421979', 'BANCO CIFRA', '233', FALSE, 'RSFN', 'Banco Cifra S.A.', '2002/04/22'),
                            ('65913436', 'GUIDE', '177', FALSE, 'RSFN', 'Guide Investimentos S.A. Corretora de Valores', '2017/05/08'),
                            ('68900810', 'BCO RENDIMENTO S.A.', '633', TRUE, 'RSFN', 'Banco Rendimento S.A.', '2002/04/22'),
                            ('71027866', 'BCO BS2 S.A.', '218', TRUE, 'RSFN', 'Banco BS2 S.A.', '2002/04/22'),
                            ('71371686', 'BCO OLÉ BONSUCESSO CONSIGNADO S.A.', '169', FALSE, 'RSFN', 'Banco Olé Bonsucesso Consignado S.A.', '2016/11/16'),
                            ('71590442', 'LASTRO RDV DTVM LTDA', '293', FALSE, 'Internet', 'Lastro RDV Distribuidora de Títulos e Valores Mobiliários Ltda.', '2018/09/10'),
                            ('71677850', 'FRENTE CC LTDA.', '285', FALSE, 'Internet', 'Frente Corretora de Câmbio Ltda.', '2018/09/25'),
                            ('73622748', 'B&T CC LTDA.', '080', FALSE, 'RSFN', 'BT Corretora de Câmbio Ltda.', '2010/11/18'),
                            ('74828799', 'NOVO BCO CONTINENTAL S.A. - BM', '753', TRUE, 'RSFN', 'Novo Banco Continental S.A. - Banco Múltiplo', '2002/04/22'),
                            ('75647891', 'BCO CRÉDIT AGRICOLE BR S.A.', '222', TRUE, 'RSFN', 'Banco Credit Agrícole Brasil S.A.', '2002/04/22'),
                            ('76461557', 'CCR COOPAVEL', '281', FALSE, 'RSFN', 'Cooperativa de Crédito Rural Coopavel', '2018/11/05'),
                            ('76543115', 'BANCO SISTEMA', '754', FALSE, 'RSFN', 'Banco Sistema S.A.', '2015/07/15'),
                            ('78157146', 'CREDIALIANÇA CCR', '098', TRUE, 'RSFN', 'Credialiança Cooperativa de Crédito Rural', '2011/01/18'),
                            ('78626983', 'BCO VR S.A.', '610', TRUE, 'RSFN', 'Banco VR S.A.', '2002/04/22'),
                            ('78632767', 'BCO OURINVEST S.A.', '712', FALSE, 'RSFN', 'Banco Ourinvest S.A.', '2014/01/28'),
                            ('81723108', 'CREDICOAMO', '010', TRUE, 'RSFN', 'Credicoamo Crédito Rural Cooperativa', '2012/12/10'),
                            ('89960090', 'RB CAPITAL INVESTIMENTOS DTVM LTDA.', '283', FALSE, 'RSFN', 'RB Capital Investimentos Distribuidora de Títulos e Valores Mobiliários Ltda.', '2018/07/05'),
                            ('90400888', 'BCO SANTANDER (BRASIL) S.A.', '033', TRUE, 'RSFN', 'Banco Santander (Brasil) S. A.', '2002/04/22'),
                            ('91884981', 'BANCO JOHN DEERE S.A.', '217', TRUE, 'RSFN', 'Banco John Deere S.A.', '2002/04/22'),
                            ('92702067', 'BCO DO ESTADO DO RS S.A.', '041', TRUE, 'RSFN', 'Banco do Estado do Rio Grande do Sul S.A.', '2002/04/22'),
                            ('92856905', 'ADVANCED CC LTDA', '117', FALSE, 'Internet', 'Advanced Corretora de Câmbio Ltda.', '2011/10/03'),
                            ('92874270', 'BCO A.J. RENNER S.A.', '654', TRUE, 'RSFN', 'Banco A. J. Renner S.A.', '2002/04/22'),
                            ('92894922', 'BANCO ORIGINAL', '212', TRUE, 'RSFN', 'Banco Original S.A.', '2002/04/22'),
                            ('94968518', 'DECYSEO CC LTDA.', '289', FALSE, 'Internet', 'Decyseo Corretora de Câmbio Ltda.', '2019/03/14');";
                sql.insertQuery();

                sql.Query = @"ALTER TABLE pessoa 
                              ADD COLUMN idbanco INT(11) DEFAULT NULL NULL,
                              ADD COLUMN agencia VARCHAR(20) DEFAULT '' NULL,
                              ADD COLUMN conta VARCHAR(20) DEFAULT '' NULL,
                              ADD COLUMN tipoconta CHAR(1) DEFAULT '' NULL,
                              ADD KEY fk_pessoa_banco_idx(idbanco),
                              ADD CONSTRAINT fk_pessoa_banco FOREIGN KEY(idbanco)
                                  REFERENCES banco(idbanco)";
                sql.insertQuery();
                sql.Query = @"ALTER TABLE pessoa MODIFY endereco VARCHAR(300)";
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0048_cadastrobancos");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0048_cadastrobancos";
            }
            return versao_base;
        }
    }
