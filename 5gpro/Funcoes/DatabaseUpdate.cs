    ...
    class DatabaseUpdate
    {
        ...
        private string PegarVerasoBase()
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.addParam("@migrations", "migrations");
                var data = sql.selectQueryForSingleValue();
                if (data == null)
                {
                    sql.clearParams();
                    sql.Query = @"CREATE TABLE IF NOT EXISTS migrations (
                    ...
                    sql.addParam("@versao", "0000_migration");
                    sql.insertQuery();
                    versao_base = "0000_migration";
                }
                else
                {
                    sql.clearParams();
                    sql.Query = @"SELECT nome FROM migrations ORDER BY id DESC LIMIT 1";
                    versao_base = (string)sql.selectQueryForSingleValue();
                }
                sql.Commit();
            }
            return versao_base;
        ...
        {
            CriarBase();
            string versao_base = PegarVerasoBase();
            if (versao_base == "0000_migration") versao_base = Migrate_0001(versao_base);
            if (versao_base == "0001_pais") versao_base = Migrate_0002(versao_base);
            if (versao_base == "0002_estado") versao_base = Migrate_0003(versao_base);
            if (versao_base == "0003_cidade") versao_base = Migrate_0004(versao_base);
            if (versao_base == "0004_grupoesubpessoa") versao_base = Migrate_0005(versao_base);
            if (versao_base == "0005_grupousuario") versao_base = Migrate_0006(versao_base);
            if (versao_base == "0006_grupoesubitens") versao_base = Migrate_0007(versao_base);
            if (versao_base == "0007_unidademedida") versao_base = Migrate_0008(versao_base);
            if (versao_base == "0008_item") versao_base = Migrate_0009(versao_base);
            if (versao_base == "0009_pessoa") versao_base = Migrate_0010(versao_base);
            if (versao_base == "0010_notafiscal") versao_base = Migrate_0011(versao_base);
            if (versao_base == "0011_notafiscalhasitem") versao_base = Migrate_0012(versao_base);
            if (versao_base == "0012_orcamento") versao_base = Migrate_0013(versao_base);
            if (versao_base == "0013_orcamentohasitem") versao_base = Migrate_0014(versao_base);
            if (versao_base == "0014_permissao") versao_base = Migrate_0015(versao_base);
            if (versao_base == "0015_permissaohasgrupousuario") versao_base = Migrate_0016(versao_base);
            if (versao_base == "0016_usuario") versao_base = Migrate_0017(versao_base);
            if (versao_base == "0017_logado") versao_base = Migrate_0018(versao_base);
            if (versao_base == "0018_operacao") versao_base = Migrate_0019(versao_base);
            if (versao_base == "0019_parcelaoperacao") versao_base = Migrate_0020(versao_base);
            if (versao_base == "0020_formpagamento") versao_base = Migrate_0021(versao_base);
            if (versao_base == "0021_contareceber") versao_base = Migrate_0022(versao_base);
            if (versao_base == "0022_parcelacontareceber") versao_base = Migrate_0023(versao_base);
            if (versao_base == "0023_contapagar") versao_base = Migrate_0024(versao_base);
            if (versao_base == "0024_parcelacontapagar") versao_base = Migrate_0025(versao_base);
            if (versao_base == "0025_registroestoque") versao_base = Migrate_0026(versao_base);
            if (versao_base == "0026_notafiscalterceiros") versao_base = Migrate_0027(versao_base);
            if (versao_base == "0027_notafiscalterceiroshasitem") versao_base = Migrate_0028(versao_base);
            if (versao_base == "0028_desintegracao") versao_base = Migrate_0029(versao_base);
            if (versao_base == "0029_resultadodesintegracao") versao_base = Migrate_0030(versao_base);
            if (versao_base == "0030_caixa") versao_base = Migrate_0031(versao_base);
            if (versao_base == "0031_caixaplanocontas") versao_base = Migrate_0032(versao_base);
            if (versao_base == "0032_caixalancamento") versao_base = Migrate_0033(versao_base);
            if (versao_base == "0033_caixasangria") versao_base = Migrate_0034(versao_base);
            if (versao_base == "0034_caixasangrialancamento") versao_base = Migrate_0035(versao_base);
            if (versao_base == "0035_caixalancamentocar") versao_base = Migrate_0036(versao_base);
            if (versao_base == "0036_caixalancamentocap") versao_base = Migrate_0037(versao_base);
            if (versao_base == "0037_caixalancamentosai") versao_base = Migrate_0038(versao_base);
        ...
        private string Migrate_0001(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0001_pais");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0001_pais";
            }
            return versao_base;
        }
...
<<<<<<< HEAD
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0002_estado");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0002_estado";
            }
            return versao_base;
        }
        private string Migrate_0003(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0003_cidade");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0003_cidade";
            }
            return versao_base;
        }
        private string Migrate_0004(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.Query = @"CREATE TABLE IF NOT EXISTS grupopessoa (
                            ...
                            ENGINE = InnoDB;";
                sql.insertQuery();
                sql.Query = @"CREATE TABLE IF NOT EXISTS subgrupopessoa (
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0004_grupoesubpessoa");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0004_grupoesubpessoa";
            }
            return versao_base;
        }
        private string Migrate_0005(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0005_grupousuario");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0005_grupousuario";
            }
            return versao_base;
        }
        private string Migrate_0006(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.Query = @"CREATE TABLE IF NOT EXISTS grupoitem (
                            ...
                            ENGINE = InnoDB;";
                sql.insertQuery();
                sql.Query = @"CREATE TABLE IF NOT EXISTS subgrupoitem (
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0006_grupoesubitens");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0006_grupoesubitens";
            }
            return versao_base;
        }
        private string Migrate_0007(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0007_unidademedida");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0007_unidademedida";
            }
            return versao_base;
        }
        ...
        private string Migrate_0011(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Commit();
                versao_base = "0011_notafiscalhasitem";
            }
            return versao_base;
        }
        ...
        private string Migrate_0013(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Commit();
                versao_base = "0013_orcamentohasitem";
            }
            return versao_base;
        }
...
CREATE TABLE IF NOT EXISTS `5gprodatabase`.`caixa_lancamento_cap` (
  ...
  CONSTRAINT `fk_caixa_lancamento_cap_parcela_conta_pagar1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
>>>>>>> a702782bf38838d908a871dee6a8de7caf97e9c6
...
>>>>>>> a702782bf38838d908a871dee6a8de7caf97e9c6
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0014_permissao");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0014_permissao";
            }
            return versao_base;
        }
        private string Migrate_0015(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Commit();
                versao_base = "0015_permissaohasgrupousuario";
            }
            return versao_base;
        }
        private string Migrate_0016(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0016_usuario");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0016_usuario";
            }
            return versao_base;
        }
        private string Migrate_0017(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0017_logado");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0017_logado";
            }
            return versao_base;
        }
        private string Migrate_0018(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0018_operacao");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0018_operacao";
            }
            return versao_base;
        }
        private string Migrate_0019(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0019_parcelaoperacao");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0019_parcelaoperacao";
            }
            return versao_base;
        }
        private string Migrate_0020(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.Query = @"CREATE TABLE IF NOT EXISTS formapagamento (
                            ...
                            ENGINE = InnoDB;";
                sql.insertQuery();
                sql.Query = @"INSERT INTO formapagamento (idformapagamento, nome) VALUES
                            (01, 'Dinheiro'),
                            (02, 'Cheque'),
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0020_formpagamento");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0020_formpagamento";
            }
            return versao_base;
        }
        private string Migrate_0021(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0021_contareceber");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0021_contareceber";
            }
            return versao_base;
        }
        private string Migrate_0022(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0022_parcelacontareceber");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0022_parcelacontareceber";
            }
            return versao_base;
        }
        private string Migrate_0023(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0023_contapagar");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0023_contapagar";
            }
            return versao_base;
        }
        private string Migrate_0024(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0024_parcelacontapagar");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0024_parcelacontapagar";
            }
            return versao_base;
        }
        private string Migrate_0025(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0025_registroestoque");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0025_registroestoque";
            }
            return versao_base;
        }
        private string Migrate_0026(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0026_notafiscalterceiros");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0026_notafiscalterceiros";
            }
            return versao_base;
        }
        private string Migrate_0027(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0027_notafiscalterceiroshasitem");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0027_notafiscalterceiroshasitem";
            }
            return versao_base;
        }
        private string Migrate_0028(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0028_desintegracao");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0028_desintegracao";
            }
            return versao_base;
        }
        private string Migrate_0029(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0029_resultadodesintegracao");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0029_resultadodesintegracao";
            }
            return versao_base;
        }
        private string Migrate_0030(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0030_caixa");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0030_caixa";
            }
            return versao_base;
        }
        private string Migrate_0031(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.Query = @"CREATE TABLE IF NOT EXISTS caixa_plano_contas (
                            ...
                            ENGINE = InnoDB;";
                sql.insertQuery();
                sql.Query = @"INSERT  INTO caixa_plano_contas (idcaixa_plano_contas , codigo, level, paiid, descricao, codigo_completo) VALUES 
                            (1,1,0,0,'Entradas','1'),
                            (2,2,0,0,'Saidas','2'),
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0031_caixaplanocontas");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0031_caixaplanocontas";
            }
            return versao_base;
        }
        private string Migrate_0032(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0032_caixalancamento");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0032_caixalancamento";
            }
            return versao_base;
        }
        private string Migrate_0033(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0033_caixasangria");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0033_caixasangria";
            }
            return versao_base;
        }
        private string Migrate_0034(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0034_caixasangrialancamento");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0034_caixasangrialancamento";
            }
            return versao_base;
        }
        private string Migrate_0035(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0035_caixalancamentocar");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0035_caixalancamentocar";
            }
            return versao_base;
        }
        private string Migrate_0036(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0036_caixalancamentocap");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0036_caixalancamentocap";
            }
            return versao_base;
        }
        private string Migrate_0037(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0037_caixalancamentosai");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0037_caixalancamentosai";
            }
            return versao_base;
        }
        private string Migrate_0038(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0038_caixalancamentoent");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0038_caixalancamentoent";
            }
            return versao_base;
        }
        private string Migrate_0039(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.Query = @"CREATE TABLE IF NOT EXISTS caixa_plano_contas_padrao (
                            ...
                            ENGINE = InnoDB;";
                sql.insertQuery();
                sql.Query = @"INSERT INTO caixa_plano_contas_padrao(idcaixa_plano_contas_padrao) VALUES (1);";
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0039_caixaplanocontapadrao");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0039_caixaplanocontapadrao";
            }
            return versao_base;
        }
        private string Migrate_0040(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0040_estabelecimento");
                sql.insertQuery();
                sql.Commit();
                versao_base = "0040_estabelecimento";
            }
            return versao_base;
        }
        private string Migrate_0041(string v)
        {
            ...
            using (MySQLConn sql = new MySQLConn(Connect.Conecta))
            {
                ...
                sql.insertQuery();
                sql.Query = @"INSERT INTO migrations (nome) VALUES (@versao)";
                sql.addParam("@versao", "0041_eventodeletalogado");
                sql.insertQuery();
                sql.Commit();
