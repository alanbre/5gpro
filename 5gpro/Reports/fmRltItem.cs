...
namespace _5gpro.Reports
{
    public partial class fmRltItem : Form
    {
        ...
        private void FmRltItem_Load(object sender, EventArgs e)
        {
            ...
            {
                dataTable.Rows.Add(i.ItemID, i.Descricao, i.Quantidade, i.Unimedida.Sigla, i.ValorEntrada);
            ...
            this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("EntidadeItem", dataTable));
